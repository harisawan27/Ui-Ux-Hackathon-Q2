      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-wrap items-start justify-between space-y-6 lg:space-y-0">
          ...
          <div className="w-full lg:w-1/4">
            <h2 className="text-2xl font-bold text-[#252B42]">LibasG</h2>
            <div className="flex space-x-4 mt-4">
              <Link
                ...
                aria-label="Facebook"
              >
                <Image src="/images/facebook-filled.png" alt="Facebook" width={24} height={24} className="h-6" />
              </Link>
              <Link
              ...
              >
                <Image src="/images/instagram-filled.png" alt="Instagram" width={24} height={24} className="h-6" />
              </Link>
              <Link
                ...
                aria-label="Twitter"
              >
                <Image src="/images/twitter-filled.png" alt="Twitter" width={24} height={24} className="h-6" />
              </Link>
            </div>
          </div>
          ...
          {/* Subscribe Section */}
          <div className="w-full lg:w-1/4">
            <h3 className="text-sm font-bold text-[#252B42] mb-4">
              Get in Touch
            </h3>
        ...
        <div className="mt-10 text-center lg:justify-start text-sm text-[#737373]">
          Made With Love By LibasG | All Right Reserved
        </div>
      </div>
    </footer>
  );
